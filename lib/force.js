...
var Connection = exports.Connection = function(login_url, resource_url, client_id, client_secret) {
  ...
  var proto = RecursiveResource.prototype;
  ...
  proto.listResources = this.listResources;
  proto.listSObjects = this.listSObjects;
  proto.getSObject = this.getSObject;
  proto.insert = this.insert;
  proto.query = this.query;

  for ( var res in RECURSIVE_RESOURCES ) {
    if ( RECURSIVE_RESOURCES[res] ) {
      this[res] = new RecursiveResource(res,this);
    }
  }
