...
function oauthpost(host, path, token, data) {
...
Connection.prototype.post = function(path, data) {
  return oauthpost(this.resource_url, this.base_path + this.api_version + path, this.access_token, data);
};
