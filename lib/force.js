...
var Connection = exports.Connection = function(login_url, resource_url, client_id, client_secret) {
  ...
  RecursiveResource.prototype.listResources = this.listResources;
  ...
  Tooling.prototype.listSObjects = this.listSObjects;
  Tooling.prototype.getSObject = this.getSObject;
  Tooling.prototype.insert = this.insert;
  Tooling.prototype.query = this.query;
